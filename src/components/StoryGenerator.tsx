...
/**
 * The core product: pick one of the 7 plots, paste your facts, get a story.
 */
  ...
  async function generate(e: React.FormEvent) {
    ...
    try {
      const res = await fetch("/api/generate", {
        ...
        body: JSON.stringify({ plotKey, company, facts, tone: "professional" }),
      });
  ...
  return (
    <div className="grid lg:grid-cols-2 gap-8">
      ...
      <form onSubmit={generate} className="card p-6 md:p-8 space-y-5">
        ...
        >
          {loading ? "Writing your story…" : "✨ Generate my story"}
        </button>
      ...
      <div className="card p-6 md:p-8 min-h-[400px]">
        ...
        {loading && (
          <div className="h-full flex flex-col items-center justify-center text-center">
            ...
            <p className="text-[--muted]">Structuring your narrative…</p>
          </div>
        )}
